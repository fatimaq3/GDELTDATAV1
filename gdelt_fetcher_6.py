...
def fetch_latest_url():
    # Run at midnight UTC — fetch yesterday's complete file
    # yesterday's file = the day we want to show in the dashboard
    ...
    log.info(f"Fetching GDELT v1 daily file for: {date_str}")
    return url, date_str
